 ...
 */
$string['pluginfullname'] = 'Moodle-Advacheck Distance Learning Integration Module';
$string['pluginname'] = 'Moodle-Advacheck Module';
$string['advacheck'] = 'Moodle-Advacheck Module';
$string['useadvacheck'] = 'Enable the Moodle-Advacheck Module';
$string['savedconfigsuccess'] = 'Settings saved';
$string['settings1'] = 'Advacheck System connection parameters';
$string['settings2'] = 'Parameters for checking';
$string['coursesettings'] = 'Advacheck settings';
$string['copy_descript'] = '<p>This tab is designed for copying test results from the Moodle plugin into the Moodle-Advacheck plugin</p> <br><p>If you have assignments where the parameter "Require answer locking for checking" is set to "No", before starting the copying process, set the default value for the parameter "Draft check limit for students" > 0 in the settings of the "Moodle-Advacheck" plugin, allowing students to check their drafts in the Advacheck system.</p>';
$string['copy1'] = 'Status of the documents queued for copying to Advacheck from Moodle';
$string['copy2_text'] = '<br>Click Start Copying. The Moodle plugin will be disabled, and the copying process will start</br>';
$string['copy1_cm'] = 'Number of tasks in the Distance Learning courses for which checking is enabled: {$a}';
$string['copy1_alldocs'] = 'Number of assignment responses sent to the Advacheck system for checking:{$a}';
$string['copy1_and_other'] = 'including the following statuses:';
$string['copy1_ready'] = 'checked (ready): {$a}';
$string['copy1_not_upload'] = 'Advacheck upload error: (not_upload): {$a}';
$string['copy1_uploaded'] = 'Uploaded to Advacheck (uploaded): {$a}';
$string['copy1_notchecked'] = 'Uploaded to Advacheck (notchecked): {$a}';
...
$string['default_uri_val'] = "https://testapi.advacheck.com";
$string['default_login'] = "For a test connection";
$string['default_login_val'] = "testapi@advacheck.com";
...
$string['default_soap_wsdl_val'] = "https://api.advacheck.com:4959/apiCorp/testapi?wsdl";
...
$string['header_default'] = 'Default Advacheck lesson settings';
...
$string['wait_block1'] = 'To carry out a check in Advacheck, the student must submit their submission';
$string['wait_block2'] = 'To carry out a check in Advacheck, you need to make the submission uneditable';
...
$string['stud_check1'] = 'After editing your answer you will be able to check it in Advacheck {$a} time(s)';
$string['stud_not_check'] = 'The teacher can check your answer in Advacheck';
$string['wait_upload'] = 'Waiting for automatic upload to Advacheck {$a}';
$string['wait_upload_stud'] = 'The teacher can check your answer in Advacheck';
$string['uploading'] = 'Uploading to Advacheck...';
$string['uploaded'] = 'Uploaded to Advacheck';
$string['checking'] = 'Advacheck check in progress (up to 15 min)';
...
$string['transfer_data_from_apru_table'] = "Copying check results from the Moodle plugin";
...
$string['notice1'] = 'The Moodle-Advacheck module is disabled. Press the Continue to go to the settings page.';
$string['notice2'] = 'You must select the elements of the course to be checked in the Advacheck system. Press the Continue to go to the settings page.';
...
$string['error_login'] = '<p><b>Connection error:</b></p><ol><li>Check your login or password</li><li>Make sure thay your link is valid "Access via SOAP+WSDL"</li><li>Make sure that the company\'s website in the Advacheck system is valid</li></ol>';
$string['check_site'] = '<p><b>To check the company\'s website address in the Advacheck system, go to:</b></p><span>'
        . "<span>&nbsp;</span><span>&nbsp;</span><span>&nbsp;</span><span>&nbsp;</span>"
        . '<span>{$a}</span></span>';
$string['updatereport'] = 'Update check results';
$string['checkresult'] = 'Advacheck check results';
...
$string['upload_and_check_emptydocid'] = 'Document ID in the Advacheck: \'{$a->id}\' (in serialized form: \'{$a->docidantplgt}\'), skip the document time: {$a->time}';
