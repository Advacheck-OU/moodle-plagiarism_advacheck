...
$string['copy_descript'] = '<p>This tab is designed for copying test results from the Russian Moodle plugin into the Moodle-Advacheck plugin</p> <br><p>If you have assignments where the parameter "Require answer locking for checking" is set to "No", before starting the copying process, set the default value for the parameter "Draft check limit for students" > 0 in the settings of the "Moodle-Advacheck" plugin, allowing students to check their drafts in the Advacheck system.</p>';
$string['copy1'] = 'Status of the documents queued for copying to Advacheck from Russian Moodle';
...
$string['default_uri_val'] = "https://testapi.antiplagiat.com";
$string['default_login'] = "For a test connection";
$string['default_login_val'] = "testapi@antiplagiat.com";
...
$string['default_soap_wsdl_val'] = "https://api.antiplagiat.com:4959/apiCorp/testapi?wsdl";
